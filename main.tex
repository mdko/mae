...
$\textsc{cogent}$ \footcite{amani_cogent:_2016}, \footcite{oconnor_cogent:_2016}
    \begin{itemize}
        \item High-level, pure, polymorphic language with linear types for writing low-level systems code
        \item Total functions (no recursion)
        \item Linear types for memory management and transitioning imperative C semantics to functional value semantics
