...
Garbage collection
    \begin{itemize}
        ...
        \item Question: can we get the compiler to do the memory deallocation for us? % will require a restriction of paradigms/cooperation by the programmer
    \end{itemize}
\end{frame}
...
\end{lstlisting}
    ...
    \begin{column}{0.48\textwidth}
        ...
        \item Fix with static operator $\texttt{regions\_of}$ instead of effect variables % explain in code
        \end{itemize}
\begin{lstlisting}[language=C,mathescape,basicstyle={\footnotesize\ttfamily}]
