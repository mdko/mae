...
\end{lstlisting}
    ...
    \begin{tikzpicture}
      ...
      \node[left = 1.0cm of n0] () {\textbf{s.arr}};
      \node[left = 1.0cm of n1] () {\textbf{s.base}};
      \node[left = 1.0cm of n2] () {\textbf{s.bounds}};
...
\begin{frame}{Capability Example}
    \todo{show lock with running example}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.60\textwidth}
      \begin{itemize}[<+->]
        ...
        \item Type system tracks \alert{capability} (set of live regions) and checks for needed liveness on pointer dereference % no closures, but existential types can hide pointers to escape scope of their regions
...
Ownership
    \begin{itemize}
      ...
      \todo {make this better, or don't talk about 'types', but rust}
